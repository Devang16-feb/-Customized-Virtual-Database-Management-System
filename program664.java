...
class program664
{
    public static void main(String Arg[])
    {
        try (Scanner sobj = new Scanner(System.in)) 
        {
            ...
            System.out.println("Enter the EID of employe whose Address you want to change :");
            int ID = sobj.nextInt();
            sobj.nextLine();

            System.out.println("Enter the changed Address :");
            String ChangeStr = sobj.nextLine();

            mobj.UpdateRecordAddress(ChangeStr, ID);
...
class MarvellousDBMS
{
    ...
    public void UpdateRecordAddress(String str, int ID)
    {
        ...
        {
            System.out.println("Succefully update Address of employee....");
        }
    }
}
